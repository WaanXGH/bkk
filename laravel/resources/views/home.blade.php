...
<body>
                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-lg-5 animated fadeInRight">
                            <div class="calrousel-img" style="object-fit: cover;">
                                <img src="assets/img/carousel-2.png" class="img-fluid" alt="">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                    <div class="about-item-content bg-white rounded p-5 h-100 shadow-sm">
                        <h1 class="display-4 mb-4 text-primary"><strong>Tujuan Dibentuknya BKK</strong></h1>
                        <p class="mb-3">
    ...
    <div class="container-fluid service py-5" id="relasi">
        <div class="container py-5">
            ...
            <div id="serviceCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                        <div class="row g-4 justify-content-center">
                            ...
                            <div class="col-md-6 col-lg-3 animated fadeInUp" data-wow-delay="0.2s">
                                <div class="service-item">
                                    <div class="service-img position-relative">
                                        <img src="{{ Storage::url($service->image_p) }}" class="img-fluid-relasi rounded-top w-100" style="aspect-ratio: 1/1;" alt="{{ $service->nama_p }}">
                                    </div>
                                    <div class="service-content p-4">
                                        <div class="service-content-inner">
                                            <a href="#" class="d-inline-block h5 mb-4">{{ $service->nama_p }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- Carousel Controls -->
                <button class="carousel-control-prev" type="button" data-bs-target="#serviceCarousel" data-bs-slide="prev" style="color:black">
    ...
    <!-- Blog Start -->
    <div class="container py-5" id="lowongan">
        ...
        @else
        <div id="lokerCarousel" class="carousel slide" data-bs-ride="carousel">
            <!-- Indicators -->
            <div class="carousel-indicators-lokers">
                @foreach ($loker->chunk(4) as $index => $chunk)
                <button type="button" data-bs-target="#lokerCarousel" data-bs-slide-to="{{ $index }}" class="{{ $index === 0 ? 'active' : '' }}" aria-current="{{ $index === 0 ? 'true' : '' }}" aria-label="Slide {{ $index + 1 }}"></button>
                @endforeach
            </div>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                    <div class="row g-4 justify-content-center">
                        ...
                        <div class="col-lg-3-loker col-md-6 animated fadeInUp" data-wow-delay="0.2s">
                            <div class="card-loker shadow-sm">
                                <img src="{{ asset('storage/' . $data->gambar) }}" class="card-img-top img-fluid-loker" alt="{{ $data->judul }}">
                                <div class="card-body-loker">
                                    <h3 class="h2 card-title">{{Str::limit( $data->judul, 20) }}</h3>
                                    <h5 class="card-subtitle mb-2 text-muted">Operator</h5>
                                    <hr>

                                    @php
                                    // Hitung jumlah pelamar
                                    $countPelamar = $data->pelamars->count();

                                    // Periksa apakah lowongan belum dimulai (tanggal_mulai di masa depan)
                                    if(now()->lt($data->tanggal_mulai)) {
                                    $status = 'Akan Datang';
                                    } elseif(now()->gt($data->tanggal_selesai)) {
                                    $status = 'Kadaluarsa';
                                    } else {
                                    $status = ($countPelamar >= $data->max_pelamar) ? 'Penuh' : 'Tersedia';
                                    }
                                    @endphp
                                    ...
                                    <p class="card-text">
                                        <!-- Jumlah Pelamar: {{ $countPelamar }}<br> -->
                                        Maksimal Pelamar: {{ $data->max_pelamar }}<br>
                                        Berlaku Hingga: {{ $data->tanggal_selesai }}
                                    </p>
                                    <!-- <a href="{{ route('lowongan.show', $data->id) }}" class="btn btn-warning w-100">Lihat Detail</a> -->
                                    @guest
                                    <a href="{{ route('login') }}" class="btn btn-warning w-100">Login untuk Lihat Detail</a>
                                    @else
                                    <a href="{{ route('lowongan.show', $data->id) }}" class="btn btn-warning w-100">Lihat Detail</a>
                                    @endguest
                                </div>
            ...
            <!-- Controls -->
            <button class="carousel-control-prev" type="button" data-bs-target="#lokerCarousel" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#lokerCarousel" data-bs-slide="next">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Next</span>
            </button>
        </div>
